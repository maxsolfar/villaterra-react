                      ...
                      >
                        <div>
                          <Menu.Button className="flex rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
                            ...
                            <img
                              className="h-10 w-10 rounded-full border border-gray-300 dark:border-gray-600 p-0.5 "
          ...
          <Disclosure.Panel className="md:hidden">
            ...
            {!loggedIn && (
              <div className="border-t-2 border-primary-500">
                <Link to="/sign-in" className='block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-400 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700 sm:pl-5 sm:pr-6'>
                    Sign In
                </Link>
              </div>
            )}
