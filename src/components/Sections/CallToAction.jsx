...
const CallToAction = () => {
  return (
    <div className="relative mt-8 sm:mt-16 md:mt-24 lg:mt-32 py-24">
      <div aria-hidden="true" className="hidden sm:block">
        ...
        >
          ...
          <rect
            width={404}
            height={392}
            fill="url(#287bf070-bcee-4ec8-905a-2a059a2cc4fb)"
          />
        </svg>
      </div>
      <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="relative overflow-hidden rounded-2xl bg-primary-500 px-6 py-10 shadow-xl sm:px-12 sm:py-20">
          <div
            aria-hidden="true"
